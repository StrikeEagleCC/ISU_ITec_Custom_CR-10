...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K   .6  // Unit: mm compression per 1mm/s extruder speed
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      510  // (mm) The length of filament for a complete unload.
